...
public class HotelManagementController {
    ...
    public int bookARoom(@RequestBody BookingReq bookingReq){
        ...
        return hotelManagementService.bookARoom(bookingReq);
    }
    ...
    public Hotel updateFacilities(@RequestBody List<Facility> newFacilities,
